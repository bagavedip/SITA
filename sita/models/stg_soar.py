...
class STG_SOAR(models.Model):
    ...
    """
    SOAR_ID = models.IntegerField(_("SOAR_ID"), null=False, help_text=_("SOAR Id"))
    ...
    Time = models.DateTimeField(_("Time"), max_length=2000, null=True, help_text=_("Time"))
    ...
    ClosingTime = models.DateTimeField(_("ClosingTime"), max_length=2000, null=True, help_text=_("Closing Time"))

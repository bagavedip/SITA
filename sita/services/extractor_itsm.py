            ...
            for keys in data:
                ...
                for n in numbers:
                    ...
                    itsm = {
                        ...
                        "has_resolution_attachments": data.get('has_resolution_attachments', None),
                        ...
                        "has_notes": data.get('has_notes',None),
                        ...
                        "email_ids_to_notify": data.get('email_ids_to_notify',None),
                        ...
                        "urgency_id": ITSMServices.double_nested_data(data,'urgency', 'id'),
                        ...
                        "has_request_initiated_change": data.get('has_request_initiated_change',None),
                        "request_template_task_ids": data.get('request_template_task_ids', None),
                    ...
                    number+=1
                values = EXTRACTOR_ITSM.objects.update_or_create(defaults=itsm, itsm_id=n)
...
#                end_time = timezone.now()
            ...
            audit_dict = {
                ...
                "status": status,
                "no_dump_data":number,
                "total_data":len(numbers)
            }
            print('audit dict is', audit_dict)
